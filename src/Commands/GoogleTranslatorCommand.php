...
class GoogleTranslatorCommand extends \potrans\commands\GoogleTranslatorCommand
{
	...
	protected function execute(InputInterface $input, OutputInterface $output): int
	{
		...
		try {
			...
			// MO file output
			$moOutputFile = $outputDir . pathinfo($inputFile, PATHINFO_FILENAME) . '-' . $to . '.mo';
			if ($output->isVeryVerbose()) {
			...
			// PO file output
			$poOutputFile = $outputDir . pathinfo($inputFile, PATHINFO_FILENAME) . '-' . $to . '.po';
			if ($output->isVeryVerbose()) {
